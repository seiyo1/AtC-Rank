...
- 20%でAI文面を追記（`gpt-5-nano`、失敗時テンプレへ復帰）
...
- 参考値: 
  - 灰 #808080 / 茶 #804000 / 緑 #008000 / 水 #00C0C0
  - 青 #0000FF / 黄 #C0C000 / 橙 #FF8000 / 赤 #FF0000
- difficultyが未設定の場合は rating の色を使用
...
## 11. データ設計（主要テーブル）
- users / problems / ratings / weekly_scores / submissions / streaks / user_problem_last_ac / settings / role_colors
